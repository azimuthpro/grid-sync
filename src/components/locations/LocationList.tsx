...
import { MapPin, Edit, Trash2, Plus, Zap, Settings, Activity } from 'lucide-react'
...
export function LocationList({ locations }: LocationListProps) {
      ...
      <div className="text-center py-16">
        <div className="bg-gray-900 border border-gray-700 rounded-xl p-12 max-w-md mx-auto shadow-lg">
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Dodaj pierwszą lokalizację, aby rozpocząć zarządzanie energią z instalacji fotowoltaicznej
          </p>
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-gray-100">Lokalizacje ({locations.length})</h1>
      ...
      <div className="grid gap-8">
        {locations.map((location) => (
          ...
          >
            {/* Main card */}
            <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 shadow-lg hover:shadow-xl hover:border-gray-600 transition-all duration-300">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-xs font-medium px-2 py-1 bg-emerald-900 text-emerald-300 border border-emerald-700 rounded-full">
                          Aktywne
                        </span>
                      </div>
                    </div>
                    
                    <p className="text-gray-300 font-medium mb-2">{location.city}</p>
                    
                    <div className="flex items-center gap-4">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
                        <span className="text-sm font-medium text-blue-400">Moc: {formatPower(location.pv_power_kwp)}</span>
                      </div>
                      ...
                      {location.system_losses && location.system_losses !== Math.round(SYSTEM_LOSSES * 100) && (
                        <div className="group/tooltip relative">
                          ...
                          <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-3 py-2 bg-gray-800 text-gray-200 text-xs rounded-lg shadow-xl opacity-0 group-hover/tooltip:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-20 border border-gray-700">
